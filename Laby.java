...
public class Laby  {
	...
	public static boolean non_conect(Grid g) {
	...
	public static Grid union(Grid g, Integer a, Integer b) {
		for (int i = 0; i < g.cell.length; i++) {
	...
	public static void find(Cellule ce) {
	...
	public static void main(String[] args) {
		...
		myGrid.cell[0][0].breakWallWith(Cellule.EAST);
		myGrid.cell[0][1].breakWallWith(Cellule.EAST);
		myGrid.cell[0][1].breakWallWith(Cellule.SOUTHEAST);
		myGrid.cell[0][2].breakWallWith(Cellule.EAST);
		
		myGrid.cell[1][0].breakWallWith(Cellule.SOUTHWEST);
		myGrid.cell[1][0].breakWallWith(Cellule.EAST);
		myGrid.cell[1][2].breakWallWith(Cellule.EAST);
		
		myGrid.cell[2][0].breakWallWith(Cellule.EAST);
		myGrid.cell[2][1].breakWallWith(Cellule.EAST);
